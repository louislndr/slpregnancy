...
const styles = StyleSheet.create({
  ...
  progressText: { fontFamily: 'Montserrat_400Regular', fontSize: 12, color: colors.textMuted },
  progressPct: { fontFamily: 'Montserrat_600SemiBold', fontSize: 12, color: colors.primary },
  ...
  sessionDuration: { fontFamily: 'Montserrat_400Regular', fontSize: 11, color: colors.textMuted, marginTop: 1 },
  continueBtn: { backgroundColor: colors.accent, borderRadius: 9999, paddingVertical: 12, alignItems: 'center', marginTop: spacing.sm },
  continueBtnText: { fontFamily: 'Raleway_700Bold', fontSize: 14, color: colors.white },
