...
import {
  ...
  ScrollView, Dimensions, Animated, Alert, Platform,
} from 'react-native';
      ...
      {isVisual && protocol.hasVisual ? (
        <View style={styles.visualContainer}>
          ...
          <View style={styles.breathRow}>
            <TouchableOpacity style={styles.handBtn} onPress={() => showAlert('Heart', 'Place your left hand gently on your heart. Feel it rise and fall with each breath.')}>
            ...
            <TouchableOpacity style={styles.handBtn} onPress={() => showAlert('Belly', 'Place your right hand on your belly. Feel your baby and your breath move together.')}>
          ...
          <View style={styles.transportSmall}>
            <TouchableOpacity style={styles.transportBtn} onPress={() => showAlert('Coming soon', 'Audio seek will be available once audio playback is enabled.')}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.audioContent}>
          ...
          <View style={styles.transport}>
            <TouchableOpacity style={styles.transportBtn} onPress={() => showAlert('Coming soon', 'Session navigation will be available once audio playback is enabled.')}>
          ...
          <View style={styles.bottomRow}>
            <TouchableOpacity style={styles.bottomAction} onPress={() => showAlert('Coming soon', 'Audio downloads will be available in the full version.')}>
